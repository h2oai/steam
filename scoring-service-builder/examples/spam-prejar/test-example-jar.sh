...
echo \"$text\"
echo
echo "http://localhost:55001/predict?Sorry%20%20din%20lock%20my%20keypad"
curl "http://localhost:55001/predict?Sorry%20%20din%20lock%20my%20keypad"
echo
echo
echo "Post"
...
echo
curl "http://localhost:55001/predict?UR GOING 2 BAHAMAS! CallFREEFONE 08081560665 and speak to a live operator to claim either Bahamas cruise of2000 CASH 18+only. To opt out txt X to 07786200117"
echo
