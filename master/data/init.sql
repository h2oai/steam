...
--
-- Name: meta; Type: TABLE; Schema: public; Owner: prithvi
--
...
ALTER TABLE meta OWNER TO prithvi;

--
-- Name: meta_id_seq; Type: SEQUENCE; Schema: public; Owner: prithvi
--
...
ALTER TABLE meta_id_seq OWNER TO prithvi;

--
-- Name: meta_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: prithvi
--
...
--
-- Name: pk_meta; Type: CONSTRAINT; Schema: public; Owner: prithvi
--
