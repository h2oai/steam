...
var MultinomialModelTable = (function (_super) {
    __extends(MultinomialModelTable, _super);
    function MultinomialModelTable() {
        _super.apply(this, arguments);
    }
    MultinomialModelTable.prototype.render = function () {
        var _this = this;
        return (React.createElement(Table_1.default, null, React.createElement(Row_1.default, {header: true}, React.createElement(Cell_1.default, null, React.createElement(FilterDropdown_1.default, {onFilter: this.props.onFilter.bind(this), sortCriteria: this.props.sortCriteria})), React.createElement(Cell_1.default, null, "MODEL"), React.createElement(Cell_1.default, null, "MSE"), React.createElement(Cell_1.default, null, "Logloss"), React.createElement(Cell_1.default, null, "R", React.createElement("sup", null, "2")), React.createElement(Cell_1.default, null, React.createElement("div", {className: "actions"}, "ACTIONS"))), this.props.items.map(function (model, i) {
